...
public class LangCMD extends SubCommand {
    ...
    public void execute(CommandSender s, String[] args) {
        ...
        if (args.length == 0) {
            ...
            for (com.andrei1058.bedwars.proxy.api.Language l : LanguageManager.get().getLanguages()) {
    ...
    public List<String> tabComplete(CommandSender s, String alias, String[] args, Location location) {
        ...
        for (com.andrei1058.bedwars.proxy.api.Language lang : LanguageManager.get().getLanguages()) {
            tab.add(lang.getIso());
        }
        return tab;
    }
